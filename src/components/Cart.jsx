...
const Cart = () => {
  ...
  return (
    <div className='bg-half-transparent w-full fixed nav-item top-0 right-0'>
      <div className='float-right h-screen duration-1000 ease-in-0ut dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8'>
        <div className='flex justify-between items-center'>
          <p className='font-semibold text-lg dark:text-gray-200'>Carinho</p>
          <button 
          type="button"
          style={{ color: '#000000'}}
          className='p-3 text-2xl hover:drop-shadow-xl'
        ...
        {cartData?.map((item, index) => (
          <div key={index}>
            <div>
              <div className='flex items-center leading-9 gap-5 border-color dark:border-gray-600 p-4'>
